...
export default function ReminderItem({ reminder, onEdit, onDelete, onToggleDone }) {
    ...
    const isDone = reminder.lastFired === 'done' || reminder.lastFired === new Date().toISOString().split('T')[0];
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full">
                <div className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2 text-gray-400 text-sm sm:ml-10">
                        <span className="flex items-center gap-2"><Calendar size={16} /> {formatDate(reminder.date)}</span>
